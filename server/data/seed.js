export const initialData = {
  ...
  deliveryZones: [
    { id: "zone-centro", name: "Centro", fee: 5, active: true },
    { id: "zone-jardim-america", name: "Jardim America", fee: 7, active: true },
    { id: "zone-vila-nova", name: "Vila Nova", fee: 6, active: true },
    { id: "zone-industrial", name: "Industrial", fee: 8, active: true },
    { id: "zone-universitario", name: "Universitario", fee: 4, active: true },
    { id: "zone-parque-das-flores", name: "Parque das Flores", fee: 9, active: true }
  ],
  expenses: [],
  payables: [],
  receivables: [],
